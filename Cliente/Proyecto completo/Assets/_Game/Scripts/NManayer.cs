...
public class NManayer : MonoBehaviour {
	...
	public InputField ipServidor;
	public GameObject jugador;
	public Slider slPersonaje;
	public SocketIOComponent configuracion;
	...
	public void ReactivarCanvasPorMuerte()
	{
		StartCoroutine(ReactivarCanvas());
	}

	public IEnumerator ReactivarCanvas()
	{
	...
	{
		if(nombreJugador.text == ""){
			return;
		}
		//configuracion.url = "ws://" + ipServidor.text + ":3000/socket.io/?EIO=4&transport=websocket";
		//configuracion.Connect();
